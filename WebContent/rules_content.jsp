...
<body>
		...
		<div class="header_bot">
			<div class="header_nav">
				<ul>
					...
					<li class="li1"><a href="rules.jsp">规章制度</a></li>
	...
	<div class="main">
		<div class="main_left">
			<div class="left">规章制度</div>
		</div>
		<div class="main_right">
			<div class="right_top">
				当前位置：<a href="index.jsp">网站首页</a>><a href="rules.jsp">规章制度</a>><a
					href="rules_content.jsp">正文</a>
				<hr noshade="noshade" />
			</div>
				...
				<table width="720px" height="480px">
					<tr>
						<td width="720px" height="80px"
							style="text-align: left; font-family: 微软雅黑; font-size: 20px">忻州师院社团成立申请书</td>
					</tr>
					<tr>
						<td width="720px" height="80px"><a
							href="../word/社团成立申请书.docx">附：社团成立申请书</a></td>
					</tr>
					<tr>
