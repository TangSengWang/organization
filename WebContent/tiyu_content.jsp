		...
		<div class="main_right">
			<div class="right_top">
				当前位置：<a href="index.jsp">网站首页</a>><a href="club_more.jsp">多元社团</a>><a
					href="club_intro.jsp">社团简介</a>><a href="tiyu.jsp">体育运动类社团</a>><a
					href="tiyu_content.jsp">正文</a>
				<hr noshade="noshade" />
			</div>
				...
				<table width="720px" height="480px">
					<tr>
						<td width="720px" height="80px"
							style="text-align: left; font-family: 微软雅黑; font-size: 20px; text-align: center">忻州师院学生羽毛球协会</td>
					</tr>
					<tr>
						<td width="720px" height="80px">忻州师院羽毛球协会是一个旨在为全校羽毛球爱好者提供交流切磋平台，提供教学组织比赛等活动的非营利社团组织。在这里，有大神细心教学陪练，有球友相约战个痛快，有比赛等你大显身手，有活动带你浪遍泉城！师院羽协，羽你相约，不见不散呦～</td>
					</tr>
					<tr>
