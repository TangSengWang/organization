...
<body>
		...
		<div class="header_bot">
			<div class="header_nav">
				<ul>
					...
					<li class="li1"><a href="data.jsp">资料中心</a></li>
	...
	<div class="main">
		<div class="main_left">
			<div class="left">资料中心</div>
			<div class="left_1">
				<a href="data_down.jsp">作品下载</a>
				<hr noshade="noshade" />
			</div>
			<div class="left_1">
				<a href="data_list.jsp">资料列表</a>
				<hr noshade="noshade" />
			</div>
		</div>
		<div class="main_right">
			<div class="right_top">
				当前位置：<a href="index.jsp">网站首页</a>><a href="data.jsp">资料中心</a>><a
					href="data_down.jsp">作品下载</a>
				<hr noshade="noshade" />
			</div>
