		...
		<div class="main_right">
			<div class="right_top">
				当前位置：<a href="index.jsp">网站首页</a>><a href="club_more.jsp">多元社团</a>><a
					href="club_intro.jsp">社团简介</a>><a href="lilun.jsp">理论学习类社团</a>><a
					href="lilun_content.jsp">正文</a>
				<hr noshade="noshade" />
			</div>
				...
				<table width="720px" height="480px">
					<tr>
						<td width="720px" height="80px"
							style="text-align: left; font-family: 微软雅黑; font-size: 20px; text-align: center">忻州师院学生心理健康协会</td>
					</tr>
					<tr>
						<td width="720px" height="80px">心理健康协会隶属于山东大学心理咨询中心，协助其开展心理知识的宣传和普及工作，促使大学生提高心理素质，健全人格，增强承受挫折和适应环境的能力。

							活动方面，协会不定期组织心理讲座、心理电影、心理培训以及心理知识竞赛等活动，面向全校同学，竭诚为大家服务。</td>
					</tr>
					<tr>
	...
	<div class="footer">
		<div class="footer_top">
			<div class="footer_top_inner">
				<div class="footer_l">
					<a href="#">关于我们</a> | <a href="#">联系方式</a> | <a href="#">加入收藏</a>
					| <a href="#">联系我们</a>
				</div>
				<div class="footer_m">
					<h5 class="footer_txt1">地址：山西省忻州市和平西街10号</h5>
					<h5 class="footer_txt2">非经营性互联网信息服务审批号：晋IICP备05008328</h5>
				</div>
				<div class="footer_r">
					<h5 class="footer_txt1">邮编：034000</h5>
					<h5 class="footer_txt2">版权所有：忻州师范学院</h5>
				</div>
			</div>
		</div>
		<div class="footer_bot">
			<div class="footer_bot_inner">
				友情链接：<a href="http://www2018.xztc.edu.cn/">忻州师范学院</a>
			</div>
		</div>
	</div>
	<div class="gohome">
