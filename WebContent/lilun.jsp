		...
		<div class="main_right">
			<div class="right_top">
				当前位置：<a href="index.jsp">网站首页</a>><a href="club_more.jsp">多元社团</a>><a
					href="club_windy.jsp">社团风采</a>><a href="lilun.jsp">理论学习类社团</a>
				<hr noshade="noshade" />
			</div>
			<div class="right_center">
				<table width="720px" height="480px">
					<tr>
						<td width="570px" height="40px"><a href="lilun_content.jsp"
							style="color: black">忻州师院学生心理健康协会</a></td>
						<td width="150px" height="40px" style="text-align: right">2018年9月11日</td>
					</tr>
					<tr>
