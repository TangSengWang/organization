...
<body>
	...
	<div class="banner">
		<img src="images/Carousel_01.png" style="height: 100%; width: 100%" x />
	</div>
	...
	<div class="main">
		...
		<div class="main_right">
			<div class="right_top">
				当前位置：<a href="index.jsp">网站首页</a>><a href="apply.ht.jsp" />社团申请</a>><a
					href="apply_club.jsp">申请社团</a>
				<hr noshade="noshade" />
			</div>
			<div class="right_center">
				<table width="720px" height="480px">
					<tr>
						<td align="left" height="40px"><a href="#"
							style="color: #C20723; font-weight: bold; font-family: 微软雅黑; font-size: 20px">申请社团</a></td>
					</tr>
					<tr>
						<td height="440px"></td>
					</tr>
