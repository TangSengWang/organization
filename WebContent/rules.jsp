...
<body>
	...
	<div class="main">
		...
		<div class="main_right">
			<div class="right_top">
				当前位置：<a href="index.jsp">网站首页</a>><a href="rules.jsp">规章制度</a>
				<hr noshade="noshade" />
			</div>
			<div class="right_center">
				<table width="720px" height="480px">
					<tr>
						<td width="570px" height="40px"><a href="rules_content.jsp"
							style="color: black">忻州师院社团成立申请书</a></td>
						<td width="150px" height="40px" style="text-align: right">2018年9月1日</td>
					</tr>
					<tr>
